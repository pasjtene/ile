...
<div class="flex-container4">
    <div class="flex1">
        ...
        <div class="categorie">
            <div class="category-title">
                <h3><a href="/ile/Views/anglais_groupes.php">COURS D'ITALIEN POUR ADULTES</a></h3>
            </div>
        ...
        <div class="categorie">
            <div class="category-title">
                <h3><a href="/ile/Views/anglais_groupes.php">COURS D’ITALIEN POUR ENFANTS ET JEUNES</a></h3>
            </div>
    ...
    <div class="flex2">
        <div class="hexagon">
            <P class="titre_hexa">PROGRAMMES ILE-CM</P>
            <hr>
