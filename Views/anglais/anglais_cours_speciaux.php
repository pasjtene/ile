...
<div class="div2">
    <div class="text_div2">COURS SPÉCIALISÉS</div>
...
<div class="flex-container">
    ...
    <div>
        ...
        <div class="flex-container3 dessous espace_haut">
            <div>
                <h3 class="green_div3"><a class="liens_footer " href=""><h3>Cours individuels et cours en petits groupes</h3></a></h3>
                <div class="couleur_div">
                    <p>
                        Nous pouvons aussi organiser, sur demande, des cours taillés
                        sur mesure, adaptés à vos besoins ou à ceux d'un petit groupe.
                        Ces cours peuvent se dérouler dans nos locaux ou à votre domicile
                    </p>
                <p>
                    Notre secrétariat des cours se
                ...
                <h2 class="liens_footer"><a href="">Cours pour entreprises.</a></h2>
                <hr>
            </div>
