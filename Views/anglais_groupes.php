...
<div class="flex-container">
    ...
    <div>
        <div class="couleur_fond">
            <img class="float_img"  src="../Resources/img/book.PNG"><h1 class="pad">COURS EXTENSIFS, INTENSIF ET SUPER INTENSIFS</h1>
            <div class="pad justif_text">Apprenez l’anglais auprès de professionnels : L'ILE-Institute
