    ...
    <div class="left-nav">
        <div class="left-nav-contain">
            ...
            <div class="sous-titre-contenu" id="sous-titre-anglais">
                ...
                Il s’agit ici de cours de langue généraux des niveaux A1-A2 pour adultes. Les objets et contenus d’apprentissages sont conçus d’après le Cadre européen commun de référence pour les langues (CECR)<br>
                </div>
                <div class="left-nav-links">
                    <a href="">Pour adultes</a>

                    <a href="">Pour enfants et jeunes</a>

                    <a href="">Préparation aux examens</a>
        ...
        <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:980px;height:380px;overflow:hidden;visibility:hidden;"> -->
            ...
            <div id="slider-images" data-u="slides" >
                ...
                <div data-p="170.00">
                    ...
                    <div data-u="caption" data-t="4" style="position:absolute;top:30px;left:30px;width:500px;height:40px;background-color:rgba(255,188,5,0.8);font-family:Oswald,sans-serif;font-size:32px;font-weight:200;line-height:1.2;text-align:center;">Bonamoussadi : Collaboration harmonieuse</div>
                </div>
                <div data-p="170.00">
